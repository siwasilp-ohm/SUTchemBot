...
<main class="container login-wrap">
    <section class="card login-card">
        ...
        <form method="post">
            ...
            <div class="form-row"><input name="username" autocomplete="username" placeholder="username" required class="input-block"></div><br>
            <div class="form-row"><input type="password" name="password" autocomplete="current-password" placeholder="password" required class="input-block"></div><br>
